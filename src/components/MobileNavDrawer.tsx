            ...
            <div className="flex-1 overflow-y-auto pt-6 px-6 pb-12 custom-scrollbar">
              <div className="flex items-center justify-between gap-2 mb-6 px-1">
                ...
                <button
                  ...
                  type="button"
                  onClick={onClose}
                  className="p-2 rounded-full text-slate-500 hover:text-slate-900 hover:bg-slate-100 dark:text-slate-400 dark:hover:text-slate-100 dark:hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-500/50"
