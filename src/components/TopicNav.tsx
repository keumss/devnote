          ...
          return (
            <li key={topic.id}>
              <button
                ...
                className={`group flex w-full items-start gap-2 rounded-lg px-2 py-1.5 text-left text-sm leading-snug outline-none transition-colors focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-indigo-500 ${
                  isActive
