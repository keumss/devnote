  ...
  return (
    ...
    >
      <Link
        ...
        className={`group flex items-center justify-between gap-3 rounded-xl border px-3.5 py-2.5 shadow-2xs transition-[color] hover:shadow-xs ${
          isCurrentSection
      ...
      >
        <div className="flex items-center gap-2.5 min-w-0">
          <span
            className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-[11px] font-bold transition-[color] ${
              isCurrentSection
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              <h3 className="text-xs font-semibold text-slate-800 transition-[color] group-hover:text-indigo-600 dark:text-dark-slate-200 dark:group-hover:text-dark-indigo-300 sm:text-sm truncate">
                {section.title}
              </h3>
              {isCurrentSection && (
